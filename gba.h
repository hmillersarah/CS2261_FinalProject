...
#define MOS_OH(x) ((x&0xF) << 8)
#define MOS_OV(x) ((x&0xF) << 12)
#define MOS_BH(x) ((x&0xF))
#define MOS_BV(x) ((x&0xF) << 4)

// Blend
#define REG_BLDCNT (*(unsigned short *)0x4000050)
#define BLD_TOP(x) (1 << x)

#define BLD_BOT(x) (1 << (x+8))
#define BLD_STD (1 << 6)

#define REG_BLDALPHA (*(unsigned short *)0x4000052)
#define BLD_EVA(x) (x & 0x1F)
#define BLD_EVB(x) ((x&0x1F) << 8)

#define REG_BLDY (*(unsigned short *)0x4000054)
